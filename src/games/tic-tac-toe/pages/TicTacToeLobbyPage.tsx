...
const TicTacToeLobbyPage: React.FC = () => {
  ...
  }, [disconnectionMessage, clearDisconnectionMessage, navigate, gameInfo]);
  ...
  return (
    <div className="w-full max-w-md p-8 space-y-6 bg-slate-800 rounded-2xl shadow-2xl shadow-slate-950/50 border border-slate-700">
      ...
      <h2 className="text-3xl font-bold text-center text-white capitalize">{gameInfo.displayName}</h2>
